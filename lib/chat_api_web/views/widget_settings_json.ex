defmodule ChatApiWeb.WidgetSettingsJSON do
  import ChatApiWeb.JSONHelpers
  alias ChatApiWeb.AccountJSON

  def show(%{widget_settings: widget_settings}) do
    %{data: maybe(widget_settings, &expanded/1)}
  end

  def update(%{widget_settings: widget_settings}) do
    %{data: maybe(widget_settings, &basic/1)}
  end

  def basic(widget_settings) do
    %{
  ...
  def expanded(widget_settings) do
    %{
      id: widget_settings.id,
      object: "widget_settings",
      created_at: widget_settings.inserted_at,
      ...
      away_message: widget_settings.away_message,
      inbox_id: widget_settings.inbox_id,
      account: maybe(widget_settings.account, &AccountJSON.basic/1)
    }
  end
end
